    ...
    <div>
      ...
      <CModal size="lg" visible={visibleLg} onClose={() => setVisibleLg(false)}>
        ...
        <CForm className="row g-3">
            <CCol md={6} >
                <CFormInput placeholder="User Name" id="username" label="User Name" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput placeholder="Password" id="Password" label="Password" type="password" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput placeholder="Confirm Password" id="CPassword" label="Confirm Password" type="password" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={4}>
            ...
            <CCol md={6} >
                <CFormInput placeholder="Name" id="name" label="Name" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6} >
                <CFormInput placeholder="Last Name" id="name" label="Last Name" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6} >
            ...
            <CCol md={6}>
                ...
                <CButton style={{backgroundColor:'#107acc', borderColor:'black', color:'white'}} type="submit" onClick={() => setVisible(!visible)}>Add User</CButton>
            </CCol>
        </CForm>
        </CModalBody>
      </CModal>
