    ...
    <div>
      ...
      <CModal size="sm" visible={visibleSm} onClose={() => setVisibleSm(false)}>
        ...
        <CForm className="row g-3">
            ...
            <CCol md={12} >
                <CFormInput placeholder="Miliage" id="Miliage" label="Miliage" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
      ...
      <CNavbar style={{border: '1px solid gray', borderRadius:'10px', marginBottom:'10px', backgroundColor:'white'}}>
        <CContainer>
            ...
            <CCol md={6} >
                <CFormInput placeholder="Usage Reports" id="Usage Reports" label="Usage Reports" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6} >
                <CFormInput placeholder="Model" id="Model" label="Model" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6} >
