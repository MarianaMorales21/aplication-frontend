...
const Materials = () => {
  ...
  return (
    <div>
      ...
      <CTable style={{border: '1px solid gray', borderRadius:'50px'}}>
        ...
        <CTableBody>
          <CTableRow>
            ...
            <CButton style={{backgroundColor:'red', marginRight:'10px', color:'white'}} onClick={() => setVisible(true)}>Delete</CButton>
            </CTableDataCell>
          </CTableRow>
          <CTableRow>
      ...
      <CButton type="submit" style={{backgroundColor:'#107acc', borderColor:'black', color:'white'}} variant="outline" onClick={() => setVisibleLg(!visibleLg)}>
       New Material
        </CButton>
        ...
        <CForm className="row g-3">
            <CCol md={6} >
                <CFormInput placeholder="Name" id="NameId" label="Name Material" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput placeholder="Characteristics" id="Characteristics" label="Characteristics" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput id="Cost per Unit" label="Cost per Unit" placeholder="Cost per Unit" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput id="Cost per Kilometer" label="Cost per Kilometer" placeholder="Cost per Kilometert" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={12}>
              <CFormSelect id="status" label="Status" placeholder="Status" style={{borderColor:'black'}}>
      ...
      <CModal visible={visible} onClose={() => setVisible(false)}>
       ...
       <CModal size="sm" visible={visibleSm} onClose={() => setVisibleSm(false)}>
        ...
        <CForm className="row g-3">
          <CCol md={6}>
                <CFormInput id="Cost per Unit the Material" label="Cost per Unit (kilograms)" placeholder="Cost per Unit" style={{borderColor:'black'}}/>
            </CCol>
            <CCol md={6}>
                <CFormInput id="Cost per Kilometer" label="Cost per Kilometer" placeholder="Cost per Kilometert" style={{borderColor:'black'}}/>
            </CCol>
